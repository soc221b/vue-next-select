import { ref, computed, onMounted, onUpdated, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode, Fragment, renderList, withDirectives, vShow } from 'vue';
  ...
  return (openBlock(), createBlock("div", {
    ...
    createVNode("div", _hoisted_1, [
      (!_ctx.selectedlabels.length)
        ? (openBlock(), createBlock("div", _hoisted_2, toDisplayString(_ctx.placeholder) + "  ", 1 /* TEXT */))
        : createCommentVNode("v-if", true),
      (openBlock(true), createBlock(Fragment, null, renderList(_ctx.selectedlabels, (value) => {
        return (openBlock(), createBlock("div", { key: value }, toDisplayString(value), 1 /* TEXT */))
    ...
    withDirectives(createVNode("div", _hoisted_3, [
      (openBlock(true), createBlock(Fragment, null, renderList(_ctx.options, (option) => {
        ...
        }, toDisplayString(option) + " " + toDisplayString(_ctx.isOptionSelected(option)), 11 /* TEXT, CLASS, PROPS */, ["onClick"]))
      }), 256 /* UNKEYED_FRAGMENT */))
    ], 512 /* NEED_PATCH */), [
      [vShow, _ctx.isOptionOpen]
    ])
