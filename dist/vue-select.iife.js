this.VueSelect = (function (vue) {
            ...
            */
            ...
            var script = {
              ...
              setup(props, context) {
                const isOptionOpen = vue.ref(false);
                const toggleDropdown = (isOpen) => {
                  isOptionOpen.value = isOpen;
                };

                const selectedOptions = vue.ref([]);
                const selectedlabels = vue.computed(()=>{
            ...
            const _hoisted_1 = { class: "vs__input" };
            const _hoisted_2 = {
              key: 0,
              class: "vs__input__placeholder"
            };
            const _hoisted_3 = {
              ref: "dropdownRef",
              class: "vs__dropdown"
            ...
            function render(_ctx, _cache, $props, $setup, $data, $options) {
              return (vue.openBlock(), vue.createBlock("div", {
                ref: "wrapperRef",
                class: ["vs__wrapper", {'vs-active': _ctx.isOptionOpen }],
                tabindex: "0",
                onFocus: _cache[1] || (_cache[1] = $event => (_ctx.toggleDropdown(true))),
                onBlur: _cache[2] || (_cache[2] = $event => (_ctx.toggleDropdown(false)))
              }, [
                vue.createVNode("div", _hoisted_1, [
                  (!_ctx.selectedlabels.length)
                    ? (vue.openBlock(), vue.createBlock("div", _hoisted_2, vue.toDisplayString(_ctx.placeholder) + "  ", 1 /* TEXT */))
                    : vue.createCommentVNode("v-if", true),
                  (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.selectedlabels, (value) => {
                    return (vue.openBlock(), vue.createBlock("div", { key: value }, vue.toDisplayString(value), 1 /* TEXT */))
                  }), 256 /* UNKEYED_FRAGMENT */))
                ]),
                vue.withDirectives(vue.createVNode("div", _hoisted_3, [
                  (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.options, (option) => {
                    return (vue.openBlock(), vue.createBlock("div", {
                      key: option,
                      class: ["vs__dropdown__option", {
                      'vs__dropdown__option-active': _ctx.isOptionSelected(option),
                    }],
                      onClick: $event => (_ctx.optionSelectHandler(option))
                    }, vue.toDisplayString(option) + " " + vue.toDisplayString(_ctx.isOptionSelected(option)), 11 /* TEXT, CLASS, PROPS */, ["onClick"]))
                  }), 256 /* UNKEYED_FRAGMENT */))
                ], 512 /* NEED_PATCH */), [
                  [vue.vShow, _ctx.isOptionOpen]
                ])
